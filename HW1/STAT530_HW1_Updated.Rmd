...
\underline{Reason:}
It follows a chi-distribution with 1 dgrees of freedom, but it will be a non-central chi-square as y doesn't follow a standard normal distribution.\newline
...
Where, $\beta_0$ is the intercept, $\beta_1$ is the slope and $\varepsilon$ is the random error.\newline
